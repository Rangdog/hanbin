...
SELECT 'ord-bnpl-001', 'user-001', 'Tech Store Online', 28800000, 2.8, 180, 'approved', DATE_SUB(NOW(), INTERVAL 5 DAY),
...
INSERT INTO orders (id, user_id, buyer, amount, interest_rate, payment_terms, status, created_at,
                    customer_income, installment_period, monthly_payment, total_amount_with_interest, risk_score, risk_level, approved_by_admin)
SELECT 'ord-bnpl-002', 'user-002', 'Electronics Hub', 36000000, 3.8, 360, 'approved', DATE_SUB(NOW(), INTERVAL 3 DAY),
...
INSERT INTO orders (id, user_id, buyer, amount, interest_rate, payment_terms, status, created_at,
                    customer_income, installment_period, monthly_payment, total_amount_with_interest, risk_score, risk_level, approved_by_admin)
SELECT 'ord-bnpl-003', 'user-003', 'Mobile World', 28800000, 5.0, 180, 'pending', DATE_SUB(NOW(), INTERVAL 1 DAY),
...
INSERT INTO orders (id, user_id, buyer, amount, interest_rate, payment_terms, status, created_at,
                    customer_income, installment_period, monthly_payment, total_amount_with_interest, risk_score, risk_level, approved_by_admin)
SELECT 'ord-bnpl-004', 'user-001', 'Apple Store', 28776000, 3.2, 360, 'approved', DATE_SUB(NOW(), INTERVAL 7 DAY),
